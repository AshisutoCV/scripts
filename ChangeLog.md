...
## [VER=20220721b] - 2022/07/21

### 変更
#### shield-setup.sh
* 「--change-spare」にバグがあり、セットアップ出来なくなった問題を修正。

--------------------------------------------------------------


## [VER=20220721a] - 2022/07/21

### 変更
#### shield-setup.sh
* オプションなしセットアップが出来なくなっていたため緊急切り戻し。

--------------------------------------------------------------


## [VER=20220720a] - 2022/07/20　（バグ有り利用不可）

### 変更
#### shield-setup.sh
* KKAのDockerHubを利用する用「--spare」と「--change-spare」を実装。
